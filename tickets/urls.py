...
urlpatterns = [
    path('bugs/', views.BugListView.as_view(template_name='tickets/tickets.html', extra_context={'title': 'Bugs'}), name='bugs'),
    path('features/', views.FeaturesListView.as_view(template_name='tickets/tickets.html', extra_context={'title': 'Features'}), name='features'),
    path('detail/<int:pk>/', views.TicketDetailView.as_view(extra_context={'title': 'Detail'}), name='detail'),
    path('new/', views.TicketCreateView.as_view(extra_context={'title': 'New'}), name='new_ticket'),
